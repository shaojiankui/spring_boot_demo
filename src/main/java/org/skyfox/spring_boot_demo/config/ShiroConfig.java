package org.skyfox.spring_boot_demo.config;
...
import org.skyfox.spring_boot_demo.entity.CustomRealm;
...
public class ShiroConfig{
	...
	//必须要使用 @Bean 注入 MyRealm  和 Controller 中调用 Service 一样， SpringBean，不能自己 new
	 @Bean 
